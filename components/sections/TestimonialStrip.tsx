      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 lg:px-8">
        <div className="relative">
          ...
          <div className="bg-white shadow-lg border border-gray-100 rounded-2xl p-8 md:p-10">
            <p className="text-gray-600 text-lg md:text-xl leading-relaxed mb-8 font-roboto pl-10 md:pl-12">
              {featured.text}
            </p>
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="text-gray-900 font-semibold text-sm font-poppins">
                  {featured.name}
                </p>
                ...
                <div className="flex items-center gap-0.5 mt-1" aria-label={`${featured.rating} de 5 estrellas`}>
                  {Array.from({ length: 5 }).map((_, i) => (
                    <svg
                      key={i}
                      className={`w-3.5 h-3.5 ${i < featured.rating ? "text-[#ff7a00]" : "text-gray-200"}`}
                      viewBox="0 0 576 512"
                      fill="currentColor"
                      aria-hidden="true"
                    >
