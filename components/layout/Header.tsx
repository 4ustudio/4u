    ...
    >
      <div className="home-frame h-[58px] flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          <Button href={isLoggedIn ? "/agendar" : "/inscripcion"} size="sm" className="hidden lg:inline-flex px-5 py-2 text-[13px]">
            {isLoggedIn ? "Agendar clase" : "Programa tu primera sesión"}
        ...
        >
          <div className="flex flex-col px-6 py-4 gap-1">
            ...
            <div className="pt-3 space-y-2">
              <Link
                href={isLoggedIn ? "/agendar" : "/inscripcion"}
                onClick={closeMobile}
