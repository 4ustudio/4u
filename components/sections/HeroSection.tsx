...
// ─── Card de identidad — reemplaza estadísticas ficticias ───────────
const identityCard = (
  <div className="grid grid-cols-2 divide-x divide-white/10 overflow-hidden rounded-2xl border border-white/15 bg-black/45 shadow-2xl backdrop-blur-md">
    ...
    {/* Tarjeta 1: Desde los 6 años */}
    <div className="px-5 py-4">
      <svg
        className="mb-2.5 h-5 w-5 text-[#ff7a00]"
        viewBox="0 0 24 24" fill="none" stroke="currentColor"
        strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round"
        aria-hidden="true"
      >
        {/* Ícono: persona con nota musical — representa todas las edades */}
    ...
    <div className="px-5 py-4">
      <svg
        ...
        aria-hidden="true"
      >
        {/* Ícono: micrófono — academia y estudio de grabación */}
      ...
      <div className="home-frame relative z-10">
        <div className="hero-home-inner relative">
          ...
          <div className="hero-copy w-full">
            ...
            {/* Card de identidad — visible en mobile dentro del copy */}
            ...
            <div className="flex flex-wrap items-center gap-4 animate-fade-in-up anim-d6">
              ...
              {/* Audio badge — aparece solo cuando está reproduciendo */}
              <AudioExperience/>
            </div>
          </div>

          {/* Card de identidad — visible en desktop a la derecha */}
