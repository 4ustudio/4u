    ...
    <form action={action} className="bg-[#0f0f0f] border border-white/10 rounded-xl p-5 space-y-4">
      ...
      <div className="grid sm:grid-cols-3 gap-4">
        <div>
          ...
          <input type="text" name="eps" disabled={isPending} defaultValue={student.eps ?? ''} className={inputClass} placeholder="Sura, Nueva EPS…" />
        </div>
        <div>
          <label className="block text-xs text-white/50 mb-1.5">Contacto emergencia</label>
          <input type="text" name="emergency_contact_name" disabled={isPending} defaultValue={student.emergency_contact_name ?? ''} className={inputClass} placeholder="Nombre" />
        </div>
        <div>
          <label className="block text-xs text-white/50 mb-1.5">Tel. emergencia</label>
          <input type="tel" name="emergency_contact_phone" disabled={isPending} defaultValue={student.emergency_contact_phone ?? ''} className={inputClass} placeholder="3001234567" />
        </div>
      </div>
