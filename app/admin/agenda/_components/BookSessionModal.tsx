      ...
      >
        ...
        <form action={action} className="space-y-3">
          ...
          <div>
            ...
            <select name="course_id" required disabled={isPending} className={inputClass + ' appearance-none'} defaultValue="">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              ...
              <select name="classroom_id" required disabled={isPending} className={inputClass + ' appearance-none'} defaultValue="">
