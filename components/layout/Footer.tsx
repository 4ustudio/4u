    ...
    <>
      ...
      >
        <div className="w-14 h-14 rounded-full bg-[#25D366] shadow-lg flex items-center justify-center hover:scale-110 hover:shadow-xl hover:shadow-[#25D366]/30 transition-all duration-300">
          <svg className="w-7 h-7 fill-white" viewBox="0 0 448 512">
      ...
      <footer className="w-full bg-black border-t border-white/5">
        <div className="max-w-7xl mx-auto px-6 lg:px-8 py-24">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-12">
            <div className="col-span-2 md:col-span-1">
              ...
              <p className="mt-4 text-sm leading-relaxed text-white/40 max-w-xs" style={{ fontFamily: "'Roboto', sans-serif" }}>
                Cumple tus sueños musicales. Academia de música profesional para todas las edades.
              </p>
            </div>

            <div>
              <h4 className="text-white/80 font-semibold mb-6 text-sm uppercase tracking-[0.15em]" style={{ fontFamily: "'Poppins', sans-serif" }}>
                Enlaces
              </h4>
              <ul className="space-y-3">
                {[
                  ...
                  <li key={link.href}>
                    <Link
                      href={link.href}
                      className="text-sm text-white/40 hover:text-[#ff7a00] transition-colors duration-300"
            ...
            <div>
              ...
              <ul className="space-y-3">
                {[
                  ...
                  <li key={s} className="text-sm text-white/40" style={{ fontFamily: "'Roboto', sans-serif" }}>
                    {s}
                  </li>
                ))}
              </ul>
        ...
        <div className="border-t border-white/5">
          <div className="max-w-7xl mx-auto px-6 lg:px-8 py-8 flex flex-col md:flex-row items-center justify-between gap-4">
            <p className="text-sm text-white/30" style={{ fontFamily: "'Roboto', sans-serif" }}>
