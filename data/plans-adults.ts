...
export const PLANES_ADULTOS: PlanDetail[] = [
  ...
  },
  {
    ...
    highlighted: false,
    image: "/images/courses/planes-tipos/Plan Bandas.png",
  ...
  },
  {
    ...
    priceNote: "/ mes",
    description:
      "Diseñado para personas que ya tienen una canción propia, una composición original o desean realizar una versión o cover de una canción existente, acompañados durante todo el proceso creativo, musical y de producción.",
    features: [
      "Producción y desarrollo de una canción con acompañamiento personalizado.",
      "8 sesiones mensuales.",
      "Las sesiones pueden utilizarse para: Producción musical · Grabación de voces · Grabación de instrumentos · Preparación artística e interpretación · Clases del instrumento seleccionado por el alumno.",
      "Incluye acompañamiento y dirección artística del productor musical y/o coach del instrumento seleccionado.",
      "La grabación incluye 5 instrumentos, incluyendo el tuyo: Voz · Guitarra · Bajo · Teclado · Batería.",
  ...
  },
  {
    ...
    features: [
      ...
      "Equipo multidisciplinario conformado por productores, músicos, ingenieros y profesionales creativos según las necesidades del proyecto.",
      "Reunión de diagnóstico y planeación requerida.",
      "Cotización personalizada según el alcance, número de canciones y requerimientos del proyecto.",
    ],
    highlighted: false,
    priceOnRequest: true,
  ...
  },
  {
    ...
    features: [
      ...
      "Acompañamiento estratégico para garantizar coherencia entre la identidad de marca y su comunicación sonora.",
      "Equipo multidisciplinario conformado por productores, creativos, locutores, músicos e ingenieros de audio según las necesidades del proyecto.",
      "Reunión de diagnóstico requerida.",
      "Cotización personalizada según los objetivos, alcance y requerimientos de la empresa.",
    ],
    highlighted: false,
    priceOnRequest: true,
