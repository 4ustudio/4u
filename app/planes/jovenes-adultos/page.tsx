    ...
    <PageLayout>
      <section className="relative -mt-16 overflow-hidden bg-black px-6 pb-6 pt-20 lg:px-8">
        ...
        <div className="plans-frame relative flex min-h-[170px] items-end">
          <div className="border-l-4 border-[#ff7a00] pl-5 sm:pl-8">
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold tracking-normal text-white font-poppins">
              Nuestros Planes
            </h1>
            <p className="mt-3 text-base lg:text-lg text-white/85 font-roboto">
      ...
      <section className="bg-white px-6 pb-28 pt-7 text-gray-950 lg:px-8">
        <div className="plans-frame">
          ...
          <div className="mt-8 grid items-center gap-4 rounded-xl bg-white p-5 sm:p-6 shadow-xl shadow-gray-950/10 ring-1 ring-gray-200 md:grid-cols-[1.5fr_1fr_1fr] md:gap-6">
            <div className="flex items-center gap-4">
              <span className="flex h-14 w-14 shrink-0 items-center justify-center rounded-full border-4 border-[#ff6b00] text-[#ff6b00]">
              ...
              <div>
                <h2 className="text-xl sm:text-2xl font-extrabold font-poppins">¿No sabes qué plan es para ti?</h2>
                <p className="text-gray-500 font-roboto text-sm sm:text-base">Te ayudamos a elegir el mejor camino.</p>
              </div>
            </div>
...
function CTAItem({ title, text, href }: { title: string; text: string; href: string }) {
  return (
    <Link href={href} className="flex items-center justify-between gap-4 border-t border-gray-200 pt-4 md:border-t-0 md:border-l md:border-gray-200 md:pt-0 md:pl-8">
      <span className="flex h-12 w-12 shrink-0 items-center justify-center rounded-lg bg-orange-50 text-[#ff6b00]">
      ...
      <span className="min-w-0 flex-1">
        <strong className="block text-base font-extrabold font-poppins">{title}</strong>
        <span className="text-gray-500 font-roboto text-sm">{text}</span>
      </span>
