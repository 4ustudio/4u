  ...
  return (
    <section className="w-full bg-white py-3">
      <div className="home-frame">
        <div className="grid grid-cols-1 overflow-hidden rounded-md bg-zinc-900 md:grid-cols-[1fr_300px]">
          <div className="flex items-center gap-4 px-6 py-5">
            ...
            <div>
              ...
              <div className="mt-3 flex items-center gap-3">
                ...
                <div>
                  <p className="text-[12px] font-bold text-white font-poppins">María Fernanda L.</p>
                  <p className="text-[10px] text-gray-400 font-roboto">{featured.course}</p>
                </div>
              </div>
            </div>
          </div>
