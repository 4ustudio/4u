  ...
  return (
    ...
    >
      ...
      <div className="mb-6">
        ...
        <p
          className="text-[#ff7a00] font-semibold text-sm mt-1 drop-shadow-[0_0_8px_rgba(255,122,0,0.3)]"
          style={{ fontFamily: "'Poppins', sans-serif" }}
        >
          {subtitle}
        </p>
      ...
      <div className="flex items-baseline gap-1 mb-4">
        <span
          className="text-3xl font-bold text-white drop-shadow-[0_0_10px_rgba(255,255,255,0.1)]"
          style={{ fontFamily: "'Poppins', sans-serif" }}
        >
          {price}
        </span>
      ...
      {instruments && instruments.length > 0 && (
        <div className="mb-6">
          <p
            className="text-xs font-semibold text-white/30 uppercase tracking-[0.15em] mb-3"
            style={{ fontFamily: "'Poppins', sans-serif" }}
          >
            Instrumentos
          </p>
          <div className="flex flex-wrap gap-2">
            {instruments.map((inst) => (
              <span
                key={inst}
                className="text-xs px-3 py-1 rounded-full bg-white/[0.06] text-white/50 border border-white/10"
                style={{ fontFamily: "'Roboto', sans-serif" }}
              >
                {inst}
              </span>
      ...
      <ul className="space-y-3 mb-8 flex-1">
        {features.map((f, i) => (
          <li key={i} className="flex items-start gap-3 text-sm text-white/60" style={{ fontFamily: "'Roboto', sans-serif" }}>
            <span className="text-[#ff7a00] font-bold mt-0.5 drop-shadow-[0_0_4px_rgba(255,122,0,0.4)] flex-shrink-0">✓</span>
            <span>{f.text}</span>
          </li>
        ))}
      </ul>
      ...
      <Link
        href="/contacto"
        className={`w-full text-center text-white font-semibold py-3.5 rounded-full text-sm transition-all duration-300 ${
          highlighted
